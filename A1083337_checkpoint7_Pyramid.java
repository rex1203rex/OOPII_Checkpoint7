...
public class A1083337_checkpoint7_Pyramid extends JLabel implements Runnable {
    ...
    public void run() {
         ...
         ********************************************************************************************/
            ...
            for(int i=0;i<10;i++){
                this.setText(String.valueOf(i*10)+"%");
                doNothing(500);
            }
            this.setIcon(icon);
    ...
    public A1083337_checkpoint7_Pyramid(int locationX, int locationY, String text, int scaler, int horizontalAlignment) {
        ...
        imgConstruct = imgConstruct.getScaledInstance(originalGridLen/scaler*2, originalGridLen/scaler*2, Image.SCALE_DEFAULT);
